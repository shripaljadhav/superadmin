				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
						<div class="card-body">
							<!-- form start -->
						{{ Form::open(array('url' => 'admin/claim/store', 'name'=>"add-claim", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
							...
							<div class="col-sm-6">										
									<div class="form-group">
										...
										{{ Form::text('accident_date', '', array('class' => 'form-control commodate', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Invoice Date' )) }}
								...
								<div class="col-sm-6">
									<div class="form-group"> 
										...
										{{ Form::text('rego_no', @$invoicenumber, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
									...
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="claim" id="claim_yes" /><label class="form-check-label" for="claim_yes">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="claim" id="claim_no" />
												<label class="form-check-label" for="claim_no">No</label>
											</div>
											<div style="display:none;" class="form-check form-check-inline is_claim custom_form_label upload_file_field">
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="assessment_report" id="assessment_report_yes" /><label class="form-check-label" for="assessment_report_yes">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="assessment_report" id="assessment_report_no" />
												<label class="form-check-label" for="assessment_report_no">No</label>
											</div>
											<div style="display:none;" class="form-check form-check-inline is_assessment_report custom_form_label upload_file_field">
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="payslip" id="payslip_yes" /><label class="form-check-label" for="payslip_yes">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="payslip" id="payslip_no" />
												<label class="form-check-label" for="payslip_no">No</label>
											</div>
											<div style="display:none;" class="form-check form-check-inline is_payslip custom_form_label upload_file_field">
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="hirecar_agreement" id="hirecar_agreement_yes" /><label class="form-check-label" for="hirecar_agreement_yes">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="hirecar_agreement" id="hirecar_agreement_no" />
												<label class="form-check-label" for="hirecar_agreement_no">No</label>
											</div>
											<div style="display:none;" class="form-check form-check-inline is_hirecar_agreement custom_form_label upload_file_field">
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="hirecar_invoice" id="hirecar_invoice_yes" /><label class="form-check-label" for="hirecar_invoice_yes">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="hirecar_invoice" id="hirecar_invoice_no" />
												<label class="form-check-label" for="hirecar_invoice_no">No</label>
											</div>
											<div style="display:none;" class="form-check form-check-inline is_hirecar_invoice custom_form_label upload_file_field">
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="rego_paper" id="rego_paper_yes" /><label class="form-check-label" for="rego_paper_yes">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="rego_paper" id="rego_paper_no" />
												<label class="form-check-label" for="rego_paper_no">No</label>
											</div>
											<div style="display:none;" class="form-check form-check-inline is_rego_paper custom_form_label upload_file_field">
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="repair_invoice" id="repair_invoice_yes" /><label class="form-check-label" for="repair_invoice_yes">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="repair_invoice" id="repair_invoice_no" />
												<label class="form-check-label" for="repair_invoice_no">No</label>
											</div>
											<div style="display:none;" class="form-check form-check-inline is_repair_invoice custom_form_label upload_file_field">
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										<label for="claim_fault" class="col-form-label">His/Her Fault</label>
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="claim_fault" id="fault_yes" /><label class="form-check-label" for="fault_yes">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="claim_fault" id="fault_no" />
												<label class="form-check-label" for="fault_no">No</label> 
											</div> 
										</div> 
									</div>
								</div>
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="tow_invoice" id="tow_yes" /><label class="form-check-label" for="tow_yes">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="tow_invoice" id="tow_no" />
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="demand_letter" id="demand_ley" /><label class="form-check-label" for="demand_ley">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="demand_letter" id="demand_len" />
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="loss_in_paid" id="loss_in_paidy" /><label class="form-check-label" for="loss_in_paidy">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="loss_in_paid" id="loss_in_paidn" />
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="parts_invoice" id="parts_invoicey" /><label class="form-check-label" for="parts_invoicey">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="parts_invoice" id="parts_invoicen" />
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="case_closed" id="case_closedy" /><label class="form-check-label" for="case_closedy">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="case_closed" id="case_closedn" />
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" value="1" name="money_claim" id="money_claimy" /><label class="form-check-label" for="money_claimy">Yes</label>
											</div>
											<div class="form-check form-check-inline">
												<input checked type="radio" class="form-check-input" value="0" name="money_claim" id="money_claimn" />
								...
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<input type="text" name="excess_paid_qoa" class="form-control">
										</div>
									</div>
								</div>
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<input type="text" name="excess_paid_aus_taxi" class="form-control">
										</div>
									</div>
								</div>
								<div class="col-sm-6">    
									<div class="form-group row">   
										...
										<div class="col-sm-12">
											<input type="text" name="lawyers" class="form-control">
										</div>
									</div>
								</div>
								<div class="col-sm-6">    
