...
.itemv .invalid-feedback{    display: block;}
</style>
<div class="main-content">
	<section class="section">
		<div class="section-body">
			{{ Form::open(array('url' => 'modifiers/store', 'name'=>"add-learning", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
            <div class="row">
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6 itemv">
										...
										<input type="hidden" name="" id="itemseleted" data-valid="required">
									</div>
									<div class="col-md-6">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-3">
										<input type="number" name="minPermittedTotal" data-valid="" class="form-control" value="" placeholder="-" />
									</div>
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-3">
										<input type="number" name="maxPermittedTotal" data-valid="" class="form-control" value="1" placeholder="-" />
									</div>
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-3">
										<input type="number" name="maxPermittedPerOption" data-valid="" class="form-control" value="1" placeholder="-" />
									</div>
								</div>
							</div>
						</div> 
