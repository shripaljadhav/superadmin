				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
						<div class="card-body">
							<!-- form start -->
						{{ Form::open(array('url' => 'admin/invoice/store', 'name'=>"add-carcover", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
							...
							<div class="row" style="margin-top: 25px;">
								...
								<div class="col-sm-6">
									<div class="creditcardlist" style="display:none;">
...
<tr class="item_row" style="display:none;">
	<td>
		<div class="form-group">
			...
			<select id="" name="item_detail[]" class="select2dat itemamt" style="width: 100%;">
		...
		<td>
			<div class="form-group">
				...
				<select id="itemdetail" name="item_detail[]" class="select2dat"  style="width: 100%;">
					<option value="">Type or click to select an item.</option>
					@foreach(\App\Plan::orderby('plan_name','ASC')->get() as $ilist)
						<option value="{{$ilist->plan_name}}">{{$ilist->plan_name}}</option>
					@endforeach
				</select>
			</div>
		</td>
