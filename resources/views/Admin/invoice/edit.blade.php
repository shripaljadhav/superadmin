...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Edit Car</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Edit Car Cover</h3>
						</div>
					  <!-- /.card-header -->
						<div class="card-body">
							<!-- form start -->
							...
							{{ Form::hidden('invoicedetail_id', @$fetchedData->singleinvoicedetail->id) }}
								...
								<div class="row" style="margin-top: 25px;">
									...
									<div class="col-sm-6">
										<div class="creditcardlist" style="<?php if($fetchedData->customer_id != ''){ }else{ echo 'display:none;'; } ?> ">
										@if($fetchedData->customer_id != '')
											<span style="">Credit Card Detail</span><br><?php  echo 'Credit Card : '.$cusdetail->card_type; ?>
