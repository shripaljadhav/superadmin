					...
					<div class="card"> 
						<div class="card-header">   
							<div class="card-title">
								<a href="{{route('admin.thirdparty.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> New Third Party Cover</a> 
							</div> 
							<div class="card-tools card_tools">
								<form action="{{route('admin.thirdparty.index')}}">
								<div class="input-group input-group-sm" style="width: 250;">
									...
									@if(isset($_GET['s']))
										<a style="margin-left: 4px;" class="btn btn-primary" href="{{route('admin.thirdparty.index')}}">Reset</a>
									@endif
							  ...
							  <tbody class="tdata">	
							   @if(@$totalData !== 0)
								...
								<tr id="id_{{@$list->id}}"> 
								  ...
								  <td><a href="{{URL::to('/admin/thirdparty/lists/'.base64_encode(convert_uuencode(@$list->id)))}}">{{$list->invoice}}</a></td> 
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="{{URL::to('/admin/thirdparty/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="fa fa-edit"></i> Edit</a>
