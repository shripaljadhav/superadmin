		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-12">
					...
					$replace_with = array(@$invoice->customer->first_name.' '.@$invoice->customer->last_name, @$invoice->invoice,@$invoice->invoice_date, @$invoice->due_date, 'AUD'.$baldue, @Auth::user()->company_name);
