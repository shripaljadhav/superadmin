			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  {{ Form::open(array('url' => 'admin/thirdparty/email', 'name'=>"email-invoice", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="form-group"> 
										...
										{{ Form::text('from', Auth::user()->state, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
										@if ($errors->has('from'))
								...
								<div class="col-sm-12">
									<div class="form-group"> 
										...
										{{ Form::text('send_to', @$invoice->customer->email, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )) }}
					...
					$replace_with = array(@$invoice->customer->first_name.' '.@$invoice->customer->last_name, '$', number_format($invoice->amount, 2), @$invoice->invoice, @$invoice->invoice_date, @$invoice->due_date, '#', @Auth::user()->company_name,@Auth::user()->email, \URL::to('/').'/public/img/austaxilogo.PNG/');
